...
* an R package ([qtwAcademic](https://chizapoth.github.io/rpkg/qtwAcademic/))that wraps three Quarto website templates for beginners
...
I also made my own R package that wraps three templates to create Quarto websites that are frequently used by academics, [qtwAcademic](https://chizapoth.github.io/qtwAcademic/). In the following days I plan to write up more detailed explanations on how to use the package, along with some new features. 
